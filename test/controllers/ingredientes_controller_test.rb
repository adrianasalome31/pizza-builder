...
class IngredientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingrediente" do
    assert_difference('Ingrediente.count') do
      post ingredientes_url, params: { ingrediente: { nombre: @ingrediente.nombre, precio: @ingrediente.precio } }
    end
  ...
  test "should update ingrediente" do
    patch ingrediente_url(@ingrediente), params: { ingrediente: { nombre: @ingrediente.nombre, precio: @ingrediente.precio } }
